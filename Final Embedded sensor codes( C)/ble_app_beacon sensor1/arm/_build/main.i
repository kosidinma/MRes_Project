...
#line 74 "..\\..\\..\\..\\..\\Include\\boards/pca10001.h"




#line 84 "..\\..\\..\\..\\..\\Include\\boards/pca10001.h"
...
#line 107 "..\\..\\..\\..\\..\\Include\\boards/pca10001.h"
...
#line 179 "..\\main.c"
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 192, (uint8_t*) "..\\main.c"); } while (0); } } while (0);

    
    memset(&m_adv_params, 0, sizeof(m_adv_params));

    m_adv_params.type        = 0x03;
    m_adv_params.p_peer_addr = 0;                             
    m_adv_params.fp          = 0x00;
    m_adv_params.interval    = (((100) * 1000) / (UNIT_0_625_MS));
...
service_data[0].data.size    = sizeof(toSend1); 
service_data[0].data.p_data  = (uint8_t *) &toSend1; 

service_data[1].service_uuid = 0x180A;
service_data[1].data.size = sizeof(toSend2);  
...
err_code = ble_advdata_set(&advdata, 0);
do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 242, (uint8_t*) "..\\main.c"); } while (0); } } while (0);  
...
static void advertising_start(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 259, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
...
static void ble_stack_init(void)
{
    uint32_t err_code;
		...
		do { static uint32_t EVT_BUFFER[(((((((((sizeof(ble_evt_t) + (23))) < (0) ? (0) : ((sizeof(ble_evt_t) + (23))))) < (sizeof(uint32_t)) ? (sizeof(uint32_t)) : ((((sizeof(ble_evt_t) + (23))) < (0) ? (0) : ((sizeof(ble_evt_t) + (23))))))) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE; ERR_CODE = softdevice_handler_init((NRF_CLOCK_LFCLKSRC_RC_250_PPM_TEMP_4000MS_CALIBRATION), EVT_BUFFER, sizeof(EVT_BUFFER), (0) ? softdevice_evt_schedule : 0); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 275, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 282, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
{
    do { static uint32_t APP_SCHED_BUF[((((((((sizeof(app_timer_event_t))) + 8) * (((10)) + 1))) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_sched_init((sizeof(app_timer_event_t)), (10), APP_SCHED_BUF); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 289, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);
}
...
static void power_manage(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 299, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void timers_init(void)
{
    ...
    do { static uint32_t APP_TIMER_BUF[((((( (((5)) * 40) + ( 3 * (8 + (((4) + 1) + 1) * 24) ) )) - 1) / (sizeof(uint32_t))) + 1)]; uint32_t ERR_CODE = app_timer_init((0), (5), (4) + 1, APP_TIMER_BUF, (1) ? app_timer_evt_schedule : 0); do { const uint32_t LOCAL_ERR_CODE = (ERR_CODE); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 311, (uint8_t*) "..\\main.c"); } while (0); } } while (0); } while (0);
...
{
		uint32_t err_code;
		err_code = app_timer_start(m_adc_timer_id, ((uint32_t)((((833) * (uint64_t)32768) + ((((0) + 1) * 1000) / 2)) / (((0) + 1) * 1000))), 0); 
    do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 323, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
}
...
static void gap_params_init(void)
{
   ...
   err_code = sd_ble_gap_device_name_set(&sec_mode, (const uint8_t *)"Kosy_MRes",
   strlen("Kosy_MRes"));
   do { const uint32_t LOCAL_ERR_CODE = (err_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler((LOCAL_ERR_CODE), 337, (uint8_t*) "..\\main.c"); } while (0); } } while (0);
